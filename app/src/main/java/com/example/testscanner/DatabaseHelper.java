...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE table " + TABLE_NAME + "(ID INTEGER PRIMARY KEY AUTOINCREMENT, BARCODE STRING, DESCRIPTION STRING, PURCHASEORDER INTEGER, RECEIVED INTEGER, DELIVERED INTEGER)");
        db.execSQL("create table " + LOG_TABLE +" (ID INTEGER PRIMARY KEY AUTOINCREMENT,BARCODE STRING,TRANS STRING,DATETRANS STRING)");
        db.execSQL("create table " + POC_TABLE +" (ID INTEGER PRIMARY KEY AUTOINCREMENT,PONUMBER STRING,STATUS STRING,PERSONNEL STRING, DATEACOMP STRING)");
    }
    ...
    public boolean insertData(String Barcode, String Description, Integer PurchaseOrder, Integer Received ,Integer Delivered ){
